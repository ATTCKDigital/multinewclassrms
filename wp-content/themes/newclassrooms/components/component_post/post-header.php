	...
	<div class="column flex-tablet-landscape-10-12 flex-12-12">
		<div class="component-post-header">
			<header class="single-header">
				<div class="color-text-primary display-block margin-bottom-2x margin-tablet-landscape-bottom-3x align-center category category-<?= $category_slug; ?>"></div>
				<h1 class="headline2 color-text-primary align-center margin-bottom-2x margin-tablet-landscape-bottom-3x"><?php the_title();?></h1>
				<span class="eyebrow uppercase display-block align-center date"><?= get_the_time('F j, Y');?></span>
			</header>
		</div>
	</div>
	<?php if(has_post_thumbnail()){ ?>
		<div class="flex-grid component-row-full component-alignment-center padding-tablet-landscape-top-8x padding-top-4x">
			<div class="column component-row-wide align-center">
				<div class="component-post-header">
