...
define('WPE_PROD', 'ncttomultisite');
define('WPE_STAGE', 'ncttomultistg');

// Use when there are files that should ONLY be from the child theme.
...
// Disable/Enable files by commenting out here. 
